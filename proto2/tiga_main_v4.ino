// ============================================================
// TIGA — Main Application v4.0
// Wearable health tracker for elderly users
//
// What's new in v4:
//   - GPS integrated (NEO-6M, GY-GPS6MV2)
//   - Real distance in metres/km on fitness screen
//   - Walk speed (km/h) with human label
//   - GPS coordinates logged in session export
//   - GPS status shown in settings screen
//   - Graceful "searching..." when no fix indoors
